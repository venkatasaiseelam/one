...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Wedding Collections - Premium Sales</h1>
                <p>Discover the latest trends in fashion, technology and accessories for you wedding— curated just for you. Enjoy limited-time deals and free shipping on selected items.</p>
                <div>
